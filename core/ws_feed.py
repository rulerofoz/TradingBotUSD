...
_REST_TO_WS = {
    # 🇺🇸 UNITED STATES DOLLAR (USD) BASELINES
    # Major Blue-Chips & Legacy ISO Formats
    "XBTUSD":   "BTC/USD",
    "XXBTZUSD": "BTC/USD",
    "ETHUSD":   "ETH/USD",
    "XETHZUSD": "ETH/USD",
    ...
    # 🟢 TETHER STABLECOIN (USDT) BASELINES
    "XBTUSDT":  "BTC/USDT",
    "ETHUSDT":  "ETH/USDT",
    "SOLUSDT":  "SOL/USDT",
    "XRPUSDT":  "XRP/USDT",
    ...
    # 🐸 SOLANA & ETHEREUM MEMECOINS (USD & USDT)
    "FWOGUSD":   "FWOG/USD",
    "FWOGUSDT":  "FWOG/USDT",
    "PEPEUSD":   "PEPE/USD",
    "PEPEUSDT":  "PEPE/USDT",
